...
class MyRatingAndReviews extends StatefulWidget {
  List ratings;
  var serviceProviderId;
  MyRatingAndReviews({required this.ratings,this.serviceProviderId});
  @override
  _MyRatingAndReviewsState createState() => _MyRatingAndReviewsState();
}

class _MyRatingAndReviewsState extends State<MyRatingAndReviews> {
  double rating =0;
