...
import 'package:maslaha/screens/authenticaton/verify_your_email_screen_client.dart';
...
class SignUpAsClient2 extends StatefulWidget {
  ...
  late String name;
  SignUpAsClient2({required this.gender,required this.email,required this.password,required this.name,required this.photo});
  @override
