...
import 'package:maslaha/screens/complaint_box/components/complaint_dialog.dart';
import 'package:maslaha/widgets/dialog_box.dart';
...
//          height: MediaQuery.of(context).size.height,
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Complaint Type",style: TextStyle(
                  color: Color(0xff4378E3),
                  fontWeight: FontWeight.bold,
                  fontSize: 18
              ),),
                  ...
                  children: [
                    Expanded(child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Bad Behaviuor",style: TextStyle(
                            color: isBlue1?Colors.white:Color(0xff4378E3)
                          ),),
                        ),
                      ),
                    )),
                    Expanded(child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.all(10),
                        child: Center(
                          child: Text("High Prices",style: TextStyle(
                              color: isBlue2?Colors.white:Color(0xff4378E3)
                          ),),
                        ),
                      ),
                    )),
                    Expanded(child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.all(10),
                        child: Center(
                          child: Text("Delay",style: TextStyle(
                              color: isBlue3?Colors.white:Color(0xff4378E3)
                          ),),
                        ),
                      ),
                    )),
                    ...
                    children: [
                      Expanded(flex:2,child: GestureDetector(
                        ...
                        child: Container(
                          margin: EdgeInsets.only(right: 10),
                          decoration: BoxDecoration(
                              color: isBlue4?Color(0xff4378E3):Colors.white,
                              borderRadius: BorderRadius.circular(15),
                              border: Border.all(color: Colors.grey)
                          ),
                          padding: EdgeInsets.all(10),
                          child: Center(
                            child: Text("Caused Damage",style: TextStyle(
                                color: isBlue4?Colors.white:Color(0xff4378E3)
                            ),),
                          ),
                        ),
                      )),
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text("Others",style: TextStyle(
                                color: isBlue5?Colors.white:Color(0xff4378E3)
                            ),),
                          ),
                        ),
                      )),
...
//                            borderSide:BorderSide(color: Color(0xffE4DCDC)),borderRadius: BorderRadius.circular(15)),
              ...
              GestureDetector(
                onTap: ()async{
                  if(userName !="" && complaintType!="" && description!=""){
                    setState(() {
                      isLoading=true;
                    });
                    ...
                    if(response.statusCode ==200){
                      showDialog(
                        ...
                        builder: (context) {
                          return ComplaintDialog(
                            ...
                            title: "",
                            description: "Your complaint has been raised successfully.",
                      ...
                      alertToast(response.body, Color(0xff4378E3), Colors.white);
                    }
                  }else{
                    setState(() {
                      isLoading=false;
                    });
                    alertToast("Please Provide All Data ..!",Color(0xff4378E3), Colors.white);
                  }
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  ...
                  child: Center(
                    child:isLoading?
                        CircularProgressIndicator(
                          color: Colors.white,
                        ) :Text("Raise a Complaint",style: TextStyle(
                      color:Colors.white,
                      fontWeight: FontWeight.bold
